    ...
    <header class="border-b border-gray-200 sticky top-0 bg-white z-50">
            ...
            <div class="hidden md:flex items-center gap-3">
                ...
                <div class="relative" id="login-dropdown-wrapper">
                    <button id="login-dropdown-btn"
                        ...
                        Login
                        <svg class="w-4 h-4 transition-transform duration-200" id="login-chevron" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="login-dropdown-menu"
                        class="hidden absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-lg py-1.5 z-50">
                        ...
                        <a href="{{ route('filament.superadmin.auth.login') }}"
                            class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-600 transition">
        ...
        <div id="mobile-menu"
            ...
            <div class="pt-3 flex flex-col gap-2">
                ...
                <div class="space-y-2">
                    <p class="text-xs text-gray-400 font-medium px-1">Login sebagai:</p>
                    <a href="{{ route('filament.admin.auth.login') }}"
                    ...
                    <a href="{{ route('filament.superadmin.auth.login') }}"
                        class="flex items-center gap-2 w-full py-2.5 px-4 border border-amber-500 text-amber-600 rounded-md hover:bg-amber-50 transition font-medium text-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                        Super Admin
