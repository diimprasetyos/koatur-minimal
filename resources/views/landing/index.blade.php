    ...
    <header class="border-b border-gray-200 sticky top-0 bg-white z-50">
        ...
        <div id="mobile-menu"
            ...
            <div class="pt-3 flex flex-col gap-2">
                <a href="{{ route('filament.admin.auth.login') }}"
                    class="w-full text-center py-2.5 border border-blue-600 text-blue-600 rounded-md hover:bg-gray-50 transition font-medium">
                    Login
                </a>
                <a href="#"
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10 md:mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="mailto:support@example.com" class="hover:opacity-80 transition">support@example.com</a></li>
