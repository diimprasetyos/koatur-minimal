    ...
    <div class="pm-card">
        ...
        <div class="pm-body">
            ...
            <div class="pm-field">
                ...
                <input type="text" id="pm-cashier" value="{{ auth('pos')->user()->name ?? '' }}" class="pm-input"
                    placeholder="Nama kasir di struk">
            </div>

            {{-- Footer note --}}
            <div class="pm-field">
                <label class="pm-label" for="pm-note">Pesan di Struk</label>
                <input type="text" id="pm-note" value="Terima kasih telah berbelanja!" class="pm-input"
...
<style>
    ...
    .pm-btn-generate:hover {
        background: var(--blue-dark);
    }

    .pm-btn-generate:active {
        transform: scale(.98);
    }
